...
<style scoped lang="scss">
    /* This step hands off to the flow editor, which is full width, so pasted YAML
       shouldn't be read through a narrower column than the one it lands in. The
       page still fills the height it is given, and the editor takes what is left
       once the header, upload section and actions have been laid out. */
    .import-yaml {
        display: flex;
    ...
    /* The only part that should absorb the spare height. */
    .editor-section {
        display: flex;
        flex: 1;
        min-height: 0;
